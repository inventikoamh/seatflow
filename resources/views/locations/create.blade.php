...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-foreground">Create New Location</h1>
            <p class="text-muted-foreground">Add a new masjid or hall location</p>
        </div>

        <div class="bg-card rounded-lg border border-border shadow-sm">
            <form method="POST" action="{{ route('locations.store') }}" class="p-6" data-validate>
                @csrf

...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-foreground">Import Takhmeen</h1>
            <p class="text-muted-foreground mt-2">Import takhmeen records from CSV file</p>
        </div>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
        ...
        <div class="text-blue-800 space-y-2">
            <p><strong>CSV Format:</strong> Your CSV file should contain exactly 2 columns:</p>
            <ul class="list-disc list-inside ml-4 space-y-1">
                <li><strong>sabeel_code:</strong> The sabeel code (e.g., 2163, 2164)</li>
                <li><strong>amount:</strong> The takhmeen amount (e.g., 5000.00)</li>
            </ul>
            <p><strong>Event Selection:</strong> All records will be imported for the selected event.</p>
            <p><strong>Sample File:</strong> <a href="{{ route('takhmeen.sample') }}" class="text-blue-600 hover:text-blue-800 underline">Download sample CSV</a></p>
        </div>
    </div>

    <!-- Import Form -->
    <div class="bg-card p-6 rounded-lg border border-border shadow-sm">
        <form action="{{ route('takhmeen.import.preview') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
    ...
    <!-- Import History -->
    <div class="mt-8">
        <h2 class="text-xl font-semibold text-foreground mb-4">Recent Imports</h2>
        <div class="bg-card rounded-lg border border-border overflow-hidden">
            <div class="p-6 text-center text-muted-foreground">
                <p>Import history will be displayed here after successful imports.</p>
            </div>
        </div>
    </div>
</div>
